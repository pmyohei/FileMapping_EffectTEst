...
public class RootNodeView_old2 extends FrameLayout {
    ...
    public RootNodeView_old2(Context context) {
        super(context);
    ...
    public RootNodeView_old2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public RootNodeView_old2(Context context, AttributeSet attrs, int defStyleAttr) {
